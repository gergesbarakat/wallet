<nav x-data="{ open: false }" class="h-1/6  max-h-20 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'absolute': open, 'hidden': ! open}" class="hidden sm:hidden z-50 right-0 dark:bg-gray-700">
