            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-xl-8 offset-xl-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="add-room" action="{{ route('rooms.store') }}" method="post"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="room_name" id="room_name"
                                            required="" data-bv-field="room_name">
                                        @error('room_name')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="room_number" id="room_number"
                                            required="" data-bv-field="room_number">
                                        @error('room_number')
                                            <small class="help-block" data-bv-validator="file" data-bv-for="category_image"
                                                data-bv-result="NOT_VALIDATED">
                                                {{ $message }}
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="room_category" id="room_category" class="form-control" required>
                                            ...
                                            @foreach ($categories as $category)
                                                <option {{ $index <= 1 ? 'selected' : '' }} value="{{ $category->id }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="text" name="room_price" id="room_price"
                                            required="" data-bv-field="room_price">
                                        @error('room_price')
                                            <small class="help-block" data-bv-validator="file" data-bv-for="category_image"
                                                data-bv-result="NOT_VALIDATED">
                                                {{ $message }}
                                    ...
                                    <div class="form-group d-flex mt-5  mb-3 flex-wrap" style=" ">
                                        ...
                                        <img id="imageinputshow"
                                            style="   display: none; border-radius: 1.25rem !important; "
                                            class='border mt-2   rounded' alt="" width="300px"
                                            height="200px">
                                        @error('room_image')
                                            <small class="help-block" data-bv-validator="file"
