...
<meta name="viewport" content="width=device-width, initial-scale=1.0, assigned_room-scalable=0">
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Assign New Room </h3>
                                </div>
                            </div>
                        </div>
                        <!-- /Page Header -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="add-assigned_room" action="{{ route('availabilities.store') }}" method="post"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="user_id" id="user_id" class="form-control" required>
                                            <?php
                                            $categories = DB::table('users')->get()->where('type','!=','admin');

                                            ?>
                                            @foreach ($categories as $category)
                                                <option {{ $category->id == old('user_id') ? 'selected' :'' }} value="{{ $category->id }}">{{ $category->email }}</option>
                                            @endforeach
                                        </select>
                                        @error('user_id')
                                            <small class="help-block" data-bv-validator="file" data-bv-for="user_id"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="room_id" id="room_id" class="form-control" required>
                                            <?php
                                            $categories = DB::table('rooms')->get()->all();

                                            ?>
                                            @foreach ($categories as $category)
                                                <option {{ $category->id == old('room_id') ? 'selected' :'' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('room_id')
                                            <small class="help-block" data-bv-validator="file" data-bv-for="room_id"
                                                data-bv-result="NOT_VALIDATED">
                                                {{ $message }}
                                            </small>
                                        @enderror
                                ...
                                @enderror
                                    ...
                                    <div class="form-group mt-4">
                                        <button class="btn btn-primary mr-2" name="form_submit" value="submit"
                                            type="submit">  Assign New Room</button>
