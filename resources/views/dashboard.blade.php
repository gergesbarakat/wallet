<x-app-layout>
    ...
    <div class="wallet bg-white dark:bg-gray-800 p-0 h-screen max-h-screen">
        <aside class="left-wallet  h-screen">
            <div class="wallet-head">
                <h1 class="p-5"> My Wallets </h1>
        ...
        <div class="right-trans overflow-hidden h-full">
            <h1 class="p-10"> Current Balance </h1>
            <h4 id="balance"></h4>
